...
public class DepractedCoordinate {
	public double getX() {
		return x;
	}
    ...
    public boolean equals(Object o) {
		if(o instanceof DepractedCoordinate) {
		return isEqual((DepractedCoordinate)o);}
		else{return false;}
	}
	...
	public DepractedCoordinate(double x, double y, double z) {
		super();
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public double getDistance(DepractedCoordinate comparedCoordinate) {
	...
	public boolean isEqual(DepractedCoordinate comparedCoordinate) {
